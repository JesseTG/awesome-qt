...
- [edbee](https://github.com/edbee/edbee-lib) [:octocat:](https://github.com/edbee/edbee-lib) - Qt editor widget that supports multiple-caret editing, Textmate Scoping/Grammar, theming, autocompletion, and highlighting support. Think Sublime Text-like code widget.
